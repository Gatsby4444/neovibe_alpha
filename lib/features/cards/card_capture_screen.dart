    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: CameraEntrance(
          animation: _entrance,
          child: FadeTransition(
            // `CurveTween(...).animate(...)` et non `CurvedAnimation` :
            // construit dans un `build`, ce dernier fuirait (il s'abonne à son
            // parent et doit être libéré).
            opacity: CurveTween(
              curve: const Interval(0, 0.5, curve: NeoMotion.enter),
            ).animate(_entrance),
            child: Stack(
