...
/// Les lumières d'ambiance : deux taches de couleur qui dérivent lentement
/// derrière tout le parcours. Assez lentes pour ne pas se voir bouger.
class ArrivalAmbience extends StatefulWidget {
  const ArrivalAmbience({super.key, required this.child, this.intensity = 1});

  final Widget child;

  /// 0 = éteint, 1 = pleine soirée. Monte quand on entre dans la soirée.
  final double intensity;

  @override
  State<ArrivalAmbience> createState() => _ArrivalAmbienceState();
}

class _ArrivalAmbienceState extends State<ArrivalAmbience>
                ...
                builder: (context, _) {
                  ...
                  return CustomPaint(
                    painter: _AmbiencePainter(
                      a: Alignment(-0.7 + 0.25 * math.sin(t), -0.8),
                      b: Alignment(0.8, 0.6 + 0.2 * math.cos(t)),
